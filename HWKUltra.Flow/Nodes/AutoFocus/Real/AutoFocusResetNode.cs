...
{
    /// <summary>
    /// Auto focus reset node - reset axis to zero position (movegoto1 0).
    /// </summary>
    public class AutoFocusResetNode : DeviceNodeBase<AutoFocusRouter>
    {
        public override string Name { get; set; } = "AutoFocus Reset";
        ...
        public AutoFocusResetNode(AutoFocusRouter? router = null) : base(router) { }
        ...
        protected override async Task<FlowResult> ExecuteRealAsync(FlowContext context)
        {
            ...
            try
            {
                ...
                Service!.ResetAxis(instanceName);
                context.SetNodeOutput(Id, "Status", true);
                return FlowResult.Ok();
            }
            catch (Exception ex)
            {
                return FlowResult.Fail($"AutoFocus reset failed: {ex.Message}");
            }
        }

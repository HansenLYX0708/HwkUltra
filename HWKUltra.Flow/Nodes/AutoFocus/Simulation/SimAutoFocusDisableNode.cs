...
{
    /// <summary>
    /// Simulated auto focus disable node - no hardware dependency.
    /// </summary>
    public class SimAutoFocusDisableNode : LogicNodeBase
    {
        public override string Name { get; set; } = "AutoFocus Disable (Sim)";

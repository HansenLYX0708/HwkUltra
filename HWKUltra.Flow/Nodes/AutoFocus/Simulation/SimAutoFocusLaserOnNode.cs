...
{
    /// <summary>
    /// Simulated auto focus laser on node - no hardware dependency.
    /// </summary>
    public class SimAutoFocusLaserOnNode : LogicNodeBase
    {
        public override string Name { get; set; } = "AutoFocus Laser On (Sim)";
